...
for i in range(1):
    ...
    with open(filename+'/job_script', 'w') as f:
        ...
        f.write('#BSUB -u {}\n'.format(email))
        f.write('\n')
        f.write('python cpso.py --npart 10 --ndim 190 --constants 2.1 2.1 2.1 '
              + '--terms accuracy sensitivity low_number overfitting '
              + '--weights 0.1 0.6 0.2 0.1 --xbounds -6.0 6.0 '
